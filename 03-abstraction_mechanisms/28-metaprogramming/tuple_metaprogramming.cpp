...
struct Tuple : Tuple<T2, T3, T4> {
    ...
    Tuple(const T1& t1 = T1{}, const T2& t2 = T2{}, const T3& t3 = T3{}, const T4& t4 = T4{})
        : Base{t2, t3, t4}, x{t1} {}
};
...
struct Tuple<T1, T2, T3> : Tuple<T2, T3> {
    ...
    Tuple(const T1& t1 = T1{}, const T2& t2 = T2{}, const T3& t3 = T3{}) : Base{t2, t3}, x{t1} {}
};
...
Tuple<T1, T2, T3, T4> make_tuple(const T1& t1, const T2& t2 = T2{}, const T3& t3 = T3{}, const T4& t4 = T4{}) {
