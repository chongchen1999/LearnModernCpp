...
template <typename U> constexpr Quantity<U> operator*(Quantity<U> x, double y) {
  return Quantity<U>{x.val * y};
}

template <typename U> constexpr Quantity<U> operator*(double x, Quantity<U> y) {
